...
![Velocidades tele_op]({{site.baseurl}}/assets/milestone1/velocidades.png)
...
Para resolver estos problemas, se plantea programar tele-dir. En vista de los problemas planteados, se busca hacer un programa de tele-dir un programa de teleoperaciones más amigable. 
...
![XML Formato]({{site.baseurl}}/assets/milestone1/xml_struct.png)
...
No se ha desarrollado ningún mecanismo para integrar a ROS el programa aún. El primer paso será subir al repositorio en GitHub el primer release del sistema que debiera estar listo dentro de esta semana. 

Hecho esto, se publicará en los foros de ROS buscando atraer atención a este programa, y se sugerirá su incorporación al tutorial de ROS como una mejor alternativa a tele-op como sistema de teleoperaciones. Dicha sugerencia explicará como cargar tele-dir utilizando su configuración por defecto es tan o más sencillo que utilizar el tele-op ofrecido por defecto en la actualidad.
