...
![XML Formato]({{site.baseurl}}/assets/milestone1/xml_empty.png ){:height="400px" width="50px"}

Y una vez poblado se ve de la siguiente forma :

![XML Ejemplo]({{site.baseurl}}/assets/milestone1/xml_example.png ){:height="400px" width="50px"}
